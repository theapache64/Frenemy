...
import com.theah64.frenemy.android.utils.WallpaperManager;
import com.theah64.frenemy.android.utils.gpix.GPix;
import com.theah64.frenemy.android.utils.gpix.Image;
...
public class GPixCommand extends BaseCommand {
    ...
    public void handle(final Context context, final Callback callback) {
        ...
        if (keyword != null) {
            ...
            try {
                GPix.getInstance().search(keyword, numberOfImages, new com.theah64.frenemy.android.utils.gpix.Callback() {
                    @Override
