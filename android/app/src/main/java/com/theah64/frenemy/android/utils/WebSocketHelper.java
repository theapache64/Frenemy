...
public class WebSocketHelper {
    ...
    private static final String SOCKET_URL_FORMAT = App.IS_DEBUG_MODE ? "ws://192.168.1.4:8080/frenemy/v1/frenemy_socket/device/%s/%s" : "ws://theapache64.com/frenemy/v1/frenemy_socket/device/%s/%s";
