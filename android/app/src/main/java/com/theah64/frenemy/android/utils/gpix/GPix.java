...
public class GPix {
    ...
    private static final String API_URL_FORMAT = "http://theapache64.com/gpix/v1/gpix?keyword=%s&limit=%d";
    ...
    public void search(String keyword, int limit, final com.theah64.frenemy.android.utils.gpix.Callback callback) throws GPixException, IOException, JSONException {
